...
function filterDemoExpenses(params: { status?: string | null; employeeId?: string | null; type?: string | null; page: number; limit: number }) {
...
export async function GET(req: NextRequest) {
  ...
  try {
    ...
    console.error('Expenses GET error, using demo data:', error);
  }

  // Demo data fallback (when DB is empty or unavailable)
  return filterDemoExpenses({ status, employeeId, type, page, limit });
}
